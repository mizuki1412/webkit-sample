export function useLoading(loadingValue, fn = function () {}) {
  // 环境变量不同
...
export function useLoadingModal(modalValue, fn = function () {}) {
  return async function (...rest) {
...
// object.loading
export function useLoadingObject(object, fn = function () {}) {
  return async function (...rest) {
    object.loading = true
    try {
      await fn.apply(this, rest)
